            ...
            <a href="javascript:void(0)" class="btn-circle btn-google">
              <i class="zmdi zmdi-google"></i>
                    ...
                    <li class="animated fadeInRight animation-delay-2">
                        <a href="https://www.facebook.com/solteszszilard.hu" class="btn-circle btn-facebook"
                            target="_blank">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="javascript:void(0)" class="dropdown-toggle animated fadeIn animation-delay-5"
                        data-toggle="dropdown" data-hover="dropdown" data-name="page">{{ trans('navbar.introduction') }}
                    ...
                    <ul class="dropdown-menu dropdown-menu-left animated-2x animated fadeIn">
                        ...
                        <li>
                            <a
                                href="{{ route('pages.selfless-coaching') }}">{{ trans('navbar.helpers_are_essential') }}</a>
                        </li>
                        {{-- <li>
