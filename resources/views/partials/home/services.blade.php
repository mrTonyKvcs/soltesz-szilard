    ...
    <div class="modal-dialog animated zoomIn animated-3x" role="document">
        <div class="modal-content" style="border-bottom: 3px solid #99BCCC;">
            ...
            <div class="modal-body">
                ...
                <p>
                  A félelem egyik ellenszere a bizalom, A bizalom olyan összetevőit szükséges elsőként felerősíteni, mint a meglévő képességünkbe és tudásunkba vetett bizalom. Vagy az abba vetett bizalom, ha valami nem megy egyedül, az sikerülhet másokkal együtt, segítséggel. Néhány nagy téma, ahol a sérülések és traumák következményei, a félelem és szorongás akadályozottsága is megjelennek. 
                </p>
                <ul>
                    <li>Munkahelyi konfliktusok, stresszkezelési nehézségek</li>
                    <li>Kiégés, belső motivációvesztés, kiüresedés</li>
                    <li>Erővesztés, én-gyengeség, lelki némaság</li>
                    <li>Megrekedt élethelyzetek, sodródó életút</li>
                    ...
                    <li>Függőségek, szorongásos zavarok</li>
                </ul>
                <p>
                  Ahhoz, hogy jól használjuk az erőnket és hozzáférjünk a transzcendens csatornákhoz fontos megérteni az énünket átszövő ellenállások és védőmechanizmusok természetét. Legalább annyira fontos belátni, hogy a félelmeinkkel való szembenézésen és a kétségeink közötti kitartáson át lehet a változás felé eljutni. A tudatosság bővítése, a konstruktív belső hang olyan bizonyosság felé vezethet, hogy amit teszünk, annak értelme és olyan többlete van, ami másokat is szolgál és távlatokat hoz közelebb. 
                </p>
