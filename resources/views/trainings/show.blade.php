    ...
    <div class="ms-hero-page-override ms-hero-img-meeting ms-hero-bg-dark-light">
        <div class="container">
            <div class="text-center">
                <h1 class="no-m ms-site-title center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-5">
                    {{ $training->title }}</h1>
                <p
                    class="lead lead-lg color-light text-center center-block mt-2 mw-800 text-uppercase fw-300 animated fadeInUp animation-delay-7">
                    Esemény</p>
            </div>
        </div>
    </div>
                ...
                <article class="card card-hero wow zoomInRight animation-delay-5 mb-4">
                    <div class="card-block card-block-big">
                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table table-no-border table-striped">
                                    @foreach ($training->dates as $date)
                                        <tr>
                                            <th>
                                                <i class="zmdi zmdi-calendar mr-1 color-info"></i> Időpont
                                            </th>
                                    ...
                                    <tr>
                                        <th>
                                            <i class="fa fa-map-marker mr-1 color-danger"></i> Helyszín
                                        </th>
                                        <td>{{ $training->locale }}</td>
                                    </tr>
                                    <tr>
                                        <th>
                                            <i class="fa fa-users mr-1 color-success"></i> Esemény típusa
                                        </th>
                                        <td>{{ $training->type }}</td>
                                    </tr>
                                    @if ($training->max_person != null)
                                        <tr>
                                            <th>
                                                <i class="zmdi zmdi-accounts mr-1 color-royal"></i> Max. Létszám
                                            </th>
                                    ...
                                    @if ($training->price != null)
                                        <tr>
                                            <th>
                                                <i class="zmdi zmdi-money mr-1 color-warning"></i> Ár
                                            </th>
                        ...
                        <div class="row">
                            ...
                            <fieldset>
                                <h2 class="color-primary no-mb text-center">Jelentkezés</h2>
                                <hr>
