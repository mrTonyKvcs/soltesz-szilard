	    ...
	    <div class="col-md-12">
	        <div class="card animated materialUp animation-delay-5" ">
	            <div class="card-block card-block-big ">
	                <h1 class="no-mt ">{{ trans('navbar.life-crises') }}</h1>
	                <hr>
	                ...
	                <img src="/img/topics/életközepi-válság.jpg " alt=" " class="img-responsive imgborder ml-2 mb-2 pull-right" style="width: 50%;">
