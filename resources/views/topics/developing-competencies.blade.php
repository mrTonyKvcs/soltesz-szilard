	    ...
	    <div class="col-md-12">
	        <div class="card animated materialUp animation-delay-5" ">
	            <div class="card-block card-block-big ">
	                ...
	                <hr>
	                {{-- <img src="/img/big-B.jpg " alt=" " class="img-responsive mb-4" style="width: 100%;"> --}}
	                ...
	                <img src="/img/topics/vezetoi-kompetenciak.jpg " alt=" " class="img-responsive imgborder ml-2 mb-2 pull-right " style="width: 50%;">
